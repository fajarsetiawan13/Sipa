...
<section id="dashboard" class="py-16 min-h-screen bg-gradient-to-r from-slate-500 to-slate-800 z-0">
    <div class="container p-4 mx-auto z-10">
        <div class="flex flex-col-reverse w-full lg:flex-row">
            ...
            <div class="flex-grow card rounded-box m-2 lg:w-3/4">
                <div class="card w-full min-h-screen bg-slate-50 shadow-lg z-20">
                    <div class="card-body overflow-x-scroll">
                        <h2 class="card-title justify-between"><span>{{ $title }}</span></h2>
                        <div class="divider my-0"></div>
                        <table class="table table-compact w-full display overflow-auto p-2 z-30" id="usersTable">
                            <thead>
                                <tr>
                                    <td class="w-1/12">#</td>
                                    <td class="w-3/12 whitespace-pre-line">Nama</td>
                                    <td class="w-3/12 whitespace-pre-line">Email</td>
                                    {{-- <td>Url</td>
                                    <td>QR-Code</td> --}}
                                    <td class="w-2/12">QR-Code</td>
                                    <td class="w-2/12">Status</td>
                                    <td class="w-1/12">Aksi</td>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach($users as $u)
                                <tr class="hover">
                                    ...
                                    <td class="bg-slate-50">{{ $u->name }}</td>
                                    <td class="bg-slate-50">{{ $u->email }}</td>
