...
<section id="login-page" class="py-8 bg-slate-100">
    <div class="container py-16 px-4 mx-auto">
        ...
        <div class="card flex w-full p-6 shadow-lg bg-slate-50 lg:w-2/3 mx-auto">
            <form action="/register" method="POST">
                ...
                <div class="flex flex-col md:flex-row">
                    <div class="form-control w-full mb-2 lg:w-1/2 lg:mr-2">
                        <label class="label label-text">Nama Lengkap</label>
                    ...
                    <div class="form-control w-full mb-2 lg:w-1/2">
                        <label class="label label-text">Jenis Kelamin</label>
                ...
                <div class="flex flex-col md:flex-row">
                    ...
                    <div class="form-control w-full mb-2 lg:w-1/2">
                        <label class="label label-text">Nomor HP/Whatsapp</label>
                ...
                <div class="form-control mb-2">
                    <label class="label label-text">Alamat Domisil</label>
                ...
                <div class="flex flex-col md:flex-row">
                    ...
                    <div class="form-control w-full mb-2 lg:w-1/2">
                        <label class="label label-text">Ulangi Password</label>
                ...
                <div class="flex flex-col md:flex-row">
                    ...
                    <div class="form-control w-full mb-2 lg:w-1/2">
                        <label class="label label-text">Usia</label>
                ...
                <div class="flex flex-col md:flex-row">
                    ...
                    <div class="form-control w-full mb-2 lg:w-1/2">
                        <label class="label label-text">Tahap Alzheimer/Demensia</label>
                ...
                <div class="form-control mb-2">
                    <label class="label label-text">Deskripsi Fisik</label>
