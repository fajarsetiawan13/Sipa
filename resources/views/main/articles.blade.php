...
<section id="login-page" class="py-8 bg-slate-800">
    <div class="container py-16 px-4 mx-auto text-center">
        ...
        <div class="flex flex-wrap gap-5 justify-center">
            ...
            @foreach($posts as $p)
            <div class="max-w-[300px] bg-white rounded-lg overflow-hidden">
                <img src="{{ asset('storage/' . $p->image) }}" width="300" height="150" alt="Programming"
                    class="max-w-[300px] max-h-[150px] object-cover mb-3">
                ...
                <a href="/article/{{ $p->slug }}"
                    class="btn btn-xs text-xs lg:btn-sm lg:text-sm btn-primary text-slate-50 px-5 hover:opacity-70 mb-3">Baca
                    Selengkapnya</a>
            </div>
            @endforeach
            @else
