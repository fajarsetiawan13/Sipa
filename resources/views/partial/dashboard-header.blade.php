                ...
                <div class="dropdown dropdown-end">
                    <label tabindex="0" class="btn btn-ghost btn-circle avatar">
                        <div class="w-10 rounded-full">
                            ...
                            <img src="{{ asset('storage/' . $account[0]->image) }}" class="rounded-box max-w-[40px] max-h-[40px] object-cover" alt="{{ auth()->user()->name }}" width="40" height="40">
                            @else
                            <img src="/img/default.webp" class="rounded-box max-w-[40px] max-h-[40px] object-cover" alt="Current profile photo" width="40" height="40">
                            @endif
                        </div>
                    </label>
